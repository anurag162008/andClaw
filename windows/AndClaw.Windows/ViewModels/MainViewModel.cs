...
public sealed class MainViewModel : ObservableObject
{
    ...
    public MainViewModel()
    {
        ...
        CompleteOAuthCommand = new RelayCommand(CompleteOAuth);
    ...
    public RelayCommand CompleteOAuthCommand { get; }
    ...
    {
        if (_oauthService.TryCompleteLogin(OauthTokenInput, out var message))
        {
            ApiKey = OauthTokenInput;
            SaveSettings();
            AppendLog("oauth", "OAuth flow completed.");
        }
