...
|---|---|---|
| One-tap setup for rootfs, Node.js, system tools, OpenClaw, and Playwright Chromium | Implemented (verification workflow) | `SetupService` + Setup tab checks WSL/runtime dependencies |
...
| Runtime recovery support through foreground service, boot auto-start, app-update restart, and watchdog recovery | Replaced on Windows | Runtime Doctor + Startup Task/Task Scheduler guidance |
